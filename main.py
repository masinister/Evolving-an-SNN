...
def snn_test():
    ...
    print("Training")
    train.train(network, x_train[0:20], 64, 64)

    print("Labelling")
    train.label_neurons(network, x_train[0:256], y_train[0:256], 10, 64, 64)

    print("Testing")
    train.evaluate(network, x_train[1000:1256], y_train[1000:1256], 64, 64)
